...
-   Under the `Files` tab on the right of the screen, click on `New Folder` and
    ...
    (e.g., `~/r_intro/`). (Alternatively, type `dir.create("data_raw")`
...
will allow you to quickly get into a project again after being away from it for
some time. You may also find a README file helpful when you collaborate with
others around a bunch of files.
